...
namespace Codeed.Framework.Services
{
    public static class HttpService
    {
        ...
        {
            public abstract class WithResponse<TRet> : ControllerBase, IService<T1, TRet>
            {
                public abstract Task<TRet> ExecuteAsync(T1 param1, CancellationToken cancellationToken);
            }

            public abstract class WithoutResponse : ControllerBase, IServiceWithoutResponse<T1>
            {
        ...
        {
            public abstract class WithResponse<TRet> : ControllerBase, IService<T1, T2, TRet>
            {
                public abstract Task<TRet> ExecuteAsync(T1 param1, T2 param2, CancellationToken cancellationToken);
            }

            public abstract class WithoutResponse : ControllerBase, IServiceWithoutResponse<T1, T2>
            {
        ...
        {
            public abstract class WithResponse<TRet> : ControllerBase, IService<T1, T2, T3, TRet>
            {
                public abstract Task<TRet> ExecuteAsync(T1 param1, T2 param2, T3 param3, CancellationToken cancellationToken);
            }

            public abstract class WithoutResponse : ControllerBase, IServiceWithoutResponse<T1, T2, T3>
            {
        ...
        {
            public abstract class WithResponse<TRet> : ControllerBase, IService<TRet>
            {
                public abstract Task<TRet> ExecuteAsync(CancellationToken cancellationToken);
            }

            public abstract class WithoutResponse : ControllerBase, IService
            {
