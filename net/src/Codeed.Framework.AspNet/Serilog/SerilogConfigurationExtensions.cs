...
namespace Codeed.Framework.AspNet.Serilog
{
    ...
    {
        public static void AddSerilogApi(this IConfiguration configuration, string applicationName, Func<LoggerConfiguration, LoggerConfiguration> configureLogger = null)
        {
